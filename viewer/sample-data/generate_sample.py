...
def build_phases() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "speech_events": [
                _speech(2, "rounds_text", _ts(15), "占い師COします。初日ランダム白で席9 ジョナスを占いました。白判定です。",
                        co_declaration="seer", summary="seat 2 COs seer; seat 9 white"),
                _speech(3, "rounds_text", _ts(30), "私も占い師です。席4 SQを占って白でした。席2は何かおかしい。",
                        co_declaration="seer", summary="seat 3 counter-COs seer; seat 4 white"),
                _speech(5, "rounds_text", _ts(50), "霊媒師COはまだしません。今日処刑が出てから結果を出します。",
                        summary="seat 5 plans medium CO after first execution"),
                _speech(9, "rounds_text", _ts(70), "席2の白判定をもらった9番です。占い理由が筋が通ってる。", summary=None),
                _speech(4, "rounds_text", _ts(90), "占いが2人いる。どちらが本物か議論したい。", summary=None),
                _speech(6, "rounds_text", _ts(110), "占いCOの2人をしっかり見極めましょう。", summary=None),
                _speech(7, "rounds_text", _ts(130), "席3が偽のように見える。占い理由が雑な印象。", summary=None),
                _speech(8, "rounds_text", _ts(150), "私は席2が怪しいと感じる。席3を信じたい。", summary=None),
                _speech(1, "rounds_text", _ts(170), "席3の占い理由がパッとしない。席2の方が信用できそう。", summary=None),
                # Round 2
                _speech(2, "rounds_text", _ts(200), "席3の理由が薄いです。席3を投票候補にしたい。", summary="seat 2 nominates seat 3"),
                _speech(3, "rounds_text", _ts(215), "席2が偽です。みなさん席2に投票してください。", summary="seat 3 nominates seat 2"),
                _speech(5, "rounds_text", _ts(230), "占い騙りなら2が真の可能性が高い気がする。", summary=None),
                _speech(9, "rounds_text", _ts(250), "席2に白を貰った立場として、席3が偽だと考える。", summary=None),
            ],
            "votes": [],
            "night_actions": [],
        },
        ...
        },
        {
            ...
            "speech_events": [
                _speech(2, "rounds_text", _ts(470), "席7を占いました。黒判定です。席7 シゲミチが人狼です。", summary="seat 2 reveals seat 7 is wolf"),
                _speech(5, "rounds_text", _ts(490), "霊媒結果: 席3 ジーナは人狼でした。占い騙りで確定です。",
                        co_declaration="medium", summary="seat 5 confirms seat 3 was wolf"),
                _speech(6, "rounds_text", _ts(510), "騎士COします。昨夜は席2を護衛して、襲撃を弾きました。",
                        co_declaration="knight", summary="seat 6 reveals knight, guarded seat 2"),
                _speech(7, "rounds_text", _ts(530), "私は人狼じゃない。席2の占いは捏造です。", summary=None),
                _speech(8, "rounds_text", _ts(550), "席2 セツが本当に占い師なら、席7 黒は信じざるを得ない。", summary=None),
                _speech(1, "rounds_text", _ts(570), "占い・霊媒・騎士の3CO全部噛み合ってるので席7処刑で行きましょう。", summary=None),
            ],
            "votes": [],
            "night_actions": [],
        },
