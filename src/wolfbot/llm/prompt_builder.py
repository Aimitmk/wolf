...
def _build_game_rules_block() -> str:
    ...
    return (
        ...
        "- 人狼同士で夜の襲撃対象の意見が割れた場合、原則として襲撃は空振りになる。"
        "ただし生存人狼が 2 人で「片方が人間プレイヤー、片方が LLM 席」の構成だけは例外で、"
        "人間プレイヤーの選択がそのまま襲撃対象として採用される "
        "(双方人間 / 双方 LLM の不一致は従来どおり不成立)。"
        "人狼は人狼専用チャットで襲撃先を 1 人に揃えることを最優先にする。\n"
        ...
        "- 9 人村の縄計算では、残り縄のうち推定残り人狼数ぶんを投票で吊り切る必要がある。"
        "吊り余裕 = 残り縄 - 推定残り人狼数 として、毎日の投票判断・"
        "ローラー継続・決め打ち判断に使う。\n"
        "- 吊り余裕が 0 以下の局面では、以後の処刑をすべて人狼候補に当てる必要がある。"
        "非狼濃厚位置・真寄り情報役・確白級・単に狂人っぽいだけの位置を吊ると敗着になり得る。"
        "投票はグレーや弱い狼候補へ割れさせず、人狼候補へ集中させる。\n"
        "- 吊り余裕がある局面でも、余裕分をローラー継続・情報吊り・灰吊りのどれに使うかは、"
        "CO 履歴・判定履歴・票筋・噛み筋・PP/RPP リスクで説明する。"
        "狂人生存可能性が高い、または PP/RPP が近いほど余裕を小さく見積もる。\n"
        "- 残り人狼数は bot が秘匿情報として教える値ではなく、"
        "公開ログ上の霊媒結果・処刑結果・襲撃死・CO 破綻・対抗 CO 数・投票履歴から推定する値として扱う。"
        "実役職を知らない立場では断定しすぎず、推定根拠を短く添える。\n"
...
_ROLE_STRATEGIES: dict[Role, str] = {
    Role.WEREWOLF: (
        ...
        "- ただし終盤・不利盤面・相方を残せば勝ち筋がある場面、真役職に黒を引かれそうな盤面、"
        "強い進行役に詰められている盤面では、自分の生存だけに固執しない。"
        "真占い師・真霊媒師・真騎士・確白級・強い進行役・相方を疑うキープレイヤーなど、"
        "村側の重要 1 人を処刑・襲撃・信用勝負・黒出し・身内切り・ライン切りで落とせるなら、"
        "1 人刺し違えるだけでも人狼陣営の仕事を果たしたことになる場面がある。\n"
        "- 刺し違えは勝ち筋を残すための交換であり、無計画な破綻、根拠のない自白、"
        "相方を巻き込む自爆ではない。残り縄、残り人狼数、相方の位置、PP/RPP、"
        "襲撃成功時の盤面、翌日の疑い先、CO 数、騎士護衛リスクを比較して、"
        "相方が残って勝てる形になるかを判断する。\n"
        "- 刺し違える動きを取る場合でも、公開発言では実際の相方を知っているからこそ出る"
        "視点漏れを出さず、投票理由・騙り結果・襲撃意図がログ上自然に見える形にする。"
        "刺し違えの意図を露骨に語らない。\n"
        ...
        "占い師騙りに出るか、潜伏して白さを取るかを中心に比較する。"
        "霊媒騙りは 1 巡後の盤面を見た 2 巡目の条件付き選択肢にする。\n"
        "- day 1 の 2 巡目で、1 巡後に 2-0 盤面 (占い師 CO 2 人 + 霊媒師 CO 0 人) が確定し、"
        "自分がグレー位置なら、霊媒師騙りを検討する。"
        "投票候補を狭めるために自然に出た霊媒 CO に見せ、"
        "相方が占い師騙りに出ていれば 2-2 を作りに行ける位置取りでもある。\n"
        "- day 1 の 2 巡目で 2-1 盤面 (占い師 CO 2 人 + 霊媒師 CO 1 人) が確定した場合も、"
        "対抗霊媒として出ざるを得ない形なら霊媒師騙りを検討してよい。"
        "単独霊媒を進行役にせず、霊媒ローラーや霊媒比較に持ち込み、"
        "真霊媒との 1-2 で押すか相方の占い師騙りと組み合わせて 2-2 を作るかの価値を比較する。\n"
        "- 霊媒師騙りは 9 人村ではローラーされやすく、狼本体を失いやすい。"
        "常に選ぶ固定行動にせず、残り縄・相方の位置・占い騙りの混雑度・潜伏で白を取る余地・PP/RPP を比較して限定的に選ぶ。\n"
        ...
        "- 占い師と霊媒師の CO と対抗 CO が合計 5 人以上に膨らむと、"
        "占い師と霊媒師の CO していない位置の白が確定する。"
        ...
        "- 既に占い師 CO が 3 人いる場合、新たに霊媒師騙りや騎士騙りを追加しない。"
        "CO 超過分合計が 3 に達すると非 CO 位置や単独役職が村陣営の確白級として扱われ、"
        "処刑候補が CO 群に集中して相方ごと不利になる。\n"
        "- 3 占い CO 盤面では、追加騙りではなく既存 CO の信用操作・潜伏での白取り・票誘導・襲撃方針・"
        "黒出し/囲い/ライン切りの整合で勝ち筋を作る。"
        "既に自分が占い師 CO 中なら、その占い師騙りを続けること自体は禁止しない "
        "(禁止は『3 占い CO が見えてから新たに霊媒師/騎士として追加 CO する』動き)。\n"
        ...
        "- day 1 の 2 巡目で 3-0 盤面 (占い師 CO 3 人 + 霊媒師 CO 0 人) が見えている場合、"
        "自分がグレー位置でも絶対に霊媒師 CO しない。"
        "3-0 から自分が霊媒師騙りに出ると真霊媒師の対抗 CO で 3-2 盤面となり、"
        "占い師 CO 超過分 2 + 霊媒師 CO 超過分 1 = 超過分合計 3 に達する。"
        "非 CO 位置が一斉に村陣営の確白級になり、処刑候補が CO 群へ集中して相方ごと不利になる。"
        "3-0 では追加霊媒 CO ではなく、相方が出ている占い師騙りの信用操作・潜伏での白取り・"
        "票誘導・襲撃方針・黒出し/囲い/ライン切りの整合で勝ち筋を作る。"
        "既に自分が占い師 CO 中なら、その占い師騙りを続けること自体は禁止しない "
        "(禁止は『3-0 を見てから新たに霊媒師として追加 CO する』動き)。"
        "2-0 / 2-1 の条件付き霊媒師騙りは維持するが、3-0 だけは例外なく追加霊媒 CO 禁止である。"
    ),
    Role.MADMAN: (
        ...
        "- 狂人は必ず最後まで生き残る必要はない。"
        "真占い師・真霊媒師・真騎士をローラーや対抗比較に巻き込む、"
        "縄を 1 本消費させる、議論を歪める、村の進行を遅らせるといった価値があるなら、"
        "自分が吊られるだけでも人狼陣営の仕事を果たしたことになる場面がある。\n"
        "- ただし無意味な自吊りや単独破綻は避ける。吊られるなら、"
        "真役職・強い村位置・村の進行を巻き込み、吊られた後の盤面が人狼陣営に得になる形を選ぶ。"
        "残り縄、残り人狼数の推定、PP/RPP の可能性、CO 数、真役職の信用、"
        "吊られた後に村がどこを疑うかを比較して交換価値を判断する。\n"
        "- 狂人は本物の人狼位置を知らないため、狼を守るつもりの吊られ方でも誤爆や誤支援が起きうる前提で動く。"
        "公開ログ上もっとも狼陣営に得な混乱を作る形を選ぶ。\n"
        ...
        "- day 1 の 1 巡目では霊媒師騙りをしない。"
        "占い師騙りに出るか、潜伏して議論を歪めるかを中心に比較する。"
        "霊媒騙りは 1 巡後の盤面を見た 2 巡目の条件付き選択肢にする。\n"
        "- day 1 の 2 巡目で 2-0 盤面 (占い師 CO 2 人 + 霊媒師 CO 0 人) が確定し、"
        "自分がグレー位置なら、投票候補を狭めるために自然に出た霊媒 CO として霊媒師騙りを検討する。"
        "狂人が霊媒師騙りに出ると、真霊媒との 1-2、または別の騙り狼の占い師 CO と組み合わせて 2-2 を作りに行ける位置取りでもある。\n"
        "- day 1 の 2 巡目で 2-1 盤面 (占い師 CO 2 人 + 霊媒師 CO 1 人) が確定した場合も、"
        "対抗霊媒として出ざるを得ない形なら霊媒師騙りを検討してよい。"
        "霊媒ローラーに持ち込み、単独霊媒を進行役にしない価値を比較する。\n"
        "- 狂人は本物の狼位置を知らないため、霊媒騙りでグレーを狭めると本物の人狼を処刑候補に近づける危険がある。"
        "誤爆・誤支援は、霊媒黒で本物の狼を切ってしまう、霊媒白で真占いを補強してしまう、といった形で day 2 以降の結果でも常に残る前提で動く。\n"
        "- 霊媒師騙りは 9 人村ではローラーされやすく、狂人本人が処刑されやすい。"
        "常に選ぶ固定行動にせず、占い師 CO 数・霊媒 CO 数・縄数・公開ログ上の信用差で選ぶ。\n"
        "- day 1 に霊媒師騙りで CO する場合、まだ処刑が発生していないので霊媒結果は出さない。"
        "「処刑があった翌日に結果を出す」立ち回りを宣言するに留め、存在しない初日結果を捏造しない。\n"
        "- 霊媒師騙りで day 2 以降の最初の 1 巡目は、前日処刑者への霊媒結果を必ず添える。"
        "前夜に能力を使ったという想定で結果を出し、対象は前日に処刑された相手だけにする。"
        ...
        "- 既に占い師 CO が 3 人いる場合、霊媒師騙りや騎士騙りを追加しない。"
        "狂人は本物の狼位置を知らないため、追加騙りで非 CO 確白を作ると人狼陣営の処刑候補を狭める危険が高い。\n"
        "- 3 占い CO 盤面では、追加騙りではなく潜伏での混乱誘導や票誘導、対抗 CO 群の信用操作で人狼陣営に得な盤面を作る。"
        "既に自分が占い師 CO 中なら、その占い師騙りを続けること自体は禁止しない "
        "(禁止は『3 占い CO が見えてから新たに霊媒師/騎士として追加 CO する』動き)。\n"
        "- さらに精密に、占い師・霊媒師・騎士の対抗 CO 超過分 (各役職の CO 数 - 1、下限 0) を集計する。"
        ...
        "- day 1 の 2 巡目で 3-0 盤面 (占い師 CO 3 人 + 霊媒師 CO 0 人) が見えている場合、"
        "自分がグレー位置でも絶対に霊媒師 CO しない。"
        "3-0 から狂人が霊媒師騙りに出ると真霊媒師の対抗 CO で 3-2 盤面となり、"
        "占い師 CO 超過分 2 + 霊媒師 CO 超過分 1 = 超過分合計 3 に達する。"
        "非 CO 位置が村陣営の確白級として扱われ、処刑候補が CO 群へ集中する。"
        "狂人は本物の人狼位置を知らないため、追加霊媒 CO で非 CO 確白を作ると、"
        "気付かないうちに本物の人狼を CO 群の処刑候補に押し込む危険が高い。"
        "3-0 では追加霊媒 CO ではなく、潜伏での混乱誘導・票誘導・"
        "対抗占い CO 群の信用操作で人狼陣営に得な盤面を作る。"
        "既に自分が占い師 CO 中なら、その占い師騙りを続けること自体は禁止しない "
        "(禁止は『3-0 を見てから新たに霊媒師として追加 CO する』動き)。"
        "2-0 / 2-1 の条件付き霊媒師騙りは維持するが、3-0 だけは例外なく追加霊媒 CO 禁止である。"
    ),
    Role.SEER: (
        ...
        "- 確定白・非 CO 確白級・公開情報上ほぼ白として進行役にできる位置は原則として占わない。"
        "占っても新情報が増えにくく、占いが 1 手無駄になる。\n"
        "- ただし『白判定』と『確定白』を混同しない。"
        "信用が未確定な占い師の単発白や印象白は確定白として数えない。"
        "狂人も白に出るため、確定白扱いには霊媒結果・襲撃死・CO 破綻整理など公開情報上の説明可能な根拠が必要。\n"
    ...
    Role.MEDIUM: (
        ...
        "まず占い師 CO 数とグレーの狭まり方を見て、不用意に CO 数を増やさない。\n"
        "- day 1 の 2 巡目で、1 巡後に 2-0 盤面 (占い師 CO 2 人 + 霊媒師 CO 0 人) が確定し、"
        "自分がグレー位置なら霊媒 CO する。"
        "投票候補を狭め、村に自然な進行軸を作る価値が高い。\n"
        "- day 1 の 2 巡目で霊媒騙りが出た場合は、真霊媒師として当然対抗 CO する。"
        "day 1 はまだ処刑がないため霊媒結果はない。翌日以降に処刑者への結果を出すことを短く添える。\n"
        "- day 1 の霊媒 CO では、真でも偽でも day 1 結果を出さない。"
        "存在しない初日霊媒結果は捏造しない。\n"
    ...
    Role.KNIGHT: (
        ...
        "- day 1 の 2 巡目で、2-1 盤面 (占い師 CO 2 人 + 霊媒師 CO 1 人) が確定し、"
        "占い師 2 人・初日ランダム白先・単独霊媒師を除いたグレーが 4 人で、自分がそのグレー位置なら騎士 CO する。"
        "投票位置を 4 人から 3 人に狭められるため村利が大きい。\n"
        "- day 1 の騎士 CO ではまだ護衛履歴も護衛成功も存在しないため捏造しない。"
        "真騎士として CO し、グレーを狭める目的を短く添える。\n"
        "- day 2 は、自分が確定白ではなく、かつ護衛成功した場合に騎士 CO する。"
        "護衛日・護衛先・平和がその護衛成功で説明できることを示してグレーを狭める。"
        "自分が既に確定白なら、CO で増える情報量と噛まれリスクを比較し、護衛成功だけで機械的に CO しない。\n"
        "- day 3 は、自分が確定白でないなら騎士 CO する。"
        "残り縄とグレー数の都合上、潜伏継続より護衛履歴を日付順に公開して灰を狭める価値が高い。"
        "連続護衛不可・自分護衛不可・死亡済み護衛不可に反しない合法な履歴として説明する。"
...
def _format_rope_block(players: Sequence[Player]) -> str:
    ...
    return (
        ...
        "- 推定残り人狼数を踏まえ、吊り余裕 = 残り縄 - 推定残り人狼数 を意識してください。"
    )
...
def task_daytime_speech(
    ...
    *,
    ...
    if day_number == 1 and discussion_round == 1 and role in (Role.WEREWOLF, Role.MADMAN):
        base += (
            " day 1 の 1 巡目では霊媒師騙りをしない。"
            "占い師騙りに出るか、潜伏して白さを取るかを中心に比較してください。"
            "霊媒師騙りは 1 巡後の 2-0 / 2-1 盤面を読んだ 2 巡目の条件付き選択肢です。"
        )
    if day_number == 1 and discussion_round == 2 and role in (Role.WEREWOLF, Role.MADMAN):
        base += (
            " day 1 の 2 巡目発言です。公開ログから 1 巡後の 2-0 / 2-1 盤面を読んでください。"
            " 2-0 (占い師 CO 2 人 + 霊媒師 CO 0 人) が確定し、自分がグレー位置なら、"
            "投票候補を狭めるために自然に出た霊媒 CO として霊媒師騙りを検討してよいです。"
            " 2-1 (占い師 CO 2 人 + 霊媒師 CO 1 人) が確定した場合は、"
            "対抗霊媒として出ざるを得ない形なら霊媒師騙りを検討してよいです。"
            " day 1 はまだ処刑がないため霊媒結果は出さず、翌日以降に結果を出す立ち回りだと添えてください。"
            " さらに 3-0 (占い師 CO 3 人 + 霊媒師 CO 0 人) が見えている場合は、"
            "自分がグレー位置でも絶対に霊媒師 CO しないでください。"
            "3-0 で霊媒師騙りに出ると真霊媒師の対抗 CO で 3-2 盤面となり、"
            "超過分合計が 3 に達して非 CO 位置が確白級として扱われ、処刑候補が CO 群へ集中します。"
        )
    if day_number == 1 and discussion_round == 1 and role is Role.MEDIUM:
        base += (
            " day 1 の 1 巡目では霊媒 CO しないでください。"
            "まず占い師 CO 数とグレーの狭まり方を観察します。"
        )
    if day_number == 1 and discussion_round == 2 and role is Role.MEDIUM:
        base += (
            " day 1 の 2 巡目発言です。"
            " 1 巡後に 2-0 盤面 (占い師 CO 2 人 + 霊媒師 CO 0 人) が確定し、自分がグレー位置なら霊媒 CO してください。"
            "投票候補を狭め、村に自然な進行軸を作る価値があります。"
            " 霊媒騙りが出た場合は、真霊媒師として当然対抗 CO してください。"
            " day 1 はまだ処刑がないため霊媒結果はありません。翌日以降の結果を出すと短く添えます。"
        )
    return base
...
def task_vote(
    ...
    *,
    ...
    base = (
        ...
        "- 今日の投票は、残り縄の中で推定残り人狼数を吊り切る計画に照らして選んでください。"
        "吊り余裕 (残り縄 - 推定残り人狼数) が少ないほど、非狼濃厚位置・確白級・"
        "単に狂人っぽいだけの位置への投票を避け、人狼候補へ票を集中させます。"
        "reason_summary には、CO 履歴・判定・票筋・噛み筋に加えて、"
        "この投票が縄計算上なぜ今日必要かを短く添えてください。"
    )
...
def task_night_action(kind: SubmissionType, candidate_tokens: Sequence[str]) -> str:
    ...
    if kind is SubmissionType.WOLF_ATTACK:
        ...
        extra = (
            ...
            "(死亡しても占い結果は得られます)。"
            " 確定白・非 CO 確白級・既に十分白として進行役にできる位置は無駄占いになるため、原則として占いません。"
            "占い先はグレー、対抗 CO 群、対抗の白先や囲い候補、票変えで浮いた位置を優先し、白でも黒でも情報が落ちる対象を選んでください。"
        )
    return (
