...
class GeminiAudioAnalyzer:
    ...
    _SYSTEM_PROMPT_BASE: str = (
        ...
        "特定役職を名指しした呼びかけ (例「占い師の方は名乗り出てください」「霊媒師いますか?」「騎士は誰?」「占いCO お願いします」) → 該当役職。"
        "役職を限定しない一般的な情報請求 (例「誰か怪しい人いる?」「みんな意見を聞かせて」「気になる人を挙げて」"
        "「誰か役職持ち出てきて」「みんなどう思う?」「初日だけど何か情報ない?」) → \"info_request\"。"
        "ただし役職名を単に話題にしただけ (例「占い師の判定が気になる」「霊媒師の信用は?」) は null。"
        "個人への質問 (例「セツさん、どう思う?」) は addressed_name 側で扱い、role_callout は null。"
        "全員/全体への問いかけで意見・情報・怪しい相手・役職持ちを求めているときに \"info_request\" を立てる。\n"
...
class GroqWhisperAudioAnalyzer:
    ...
    _ANALYZER_PROMPT_BASE: str = (
        ...
        "役職を限定しない一般的な情報請求 (例「誰か怪しい人いる?」「みんな意見を聞かせて」「気になる人を挙げて」"
        "「誰か役職持ち出てきて」「みんなどう思う?」) → \"info_request\"。"
